/*
 * Register and unregister unioffice_excel.dll functions
 *
...
static WCHAR class_name1[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','1',0};
static WCHAR class_name2[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','2',0};
static WCHAR class_name3[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','3',0};
static WCHAR class_name4[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','4',0};
static WCHAR class_name5[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','5',0};
static WCHAR class_name6[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','6',0};
static WCHAR class_name7[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','7',0};
static WCHAR class_name8[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','8',0};
static WCHAR class_name9[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','9',0};
static WCHAR class_name10[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','1','0',0};
static WCHAR class_name11[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','1','1',0};

static WCHAR const class_CLSID[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','\\','C','L','S','I','D',0};
static WCHAR const class_CurVer[] = {  
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','\\','C','u','r','V','e','r',0};
static WCHAR const str_curver[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','1',0};

static WCHAR const class_CLSID1[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','1','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID2[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','2','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID3[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','3','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID4[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','4','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID5[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','5','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID6[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','6','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID7[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','7','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID8[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','8','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID9[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','9','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID10[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','1','0','\\','C','L','S','I','D',0};
static WCHAR const class_CLSID11[] = {
    'E','x','c','e','l','.','A','p','p','l','i','c','a','t','i','o','n','.','1','1','\\','C','L','S','I','D',0};
...
__declspec(dllexport) HRESULT __stdcall DllUnregisterServer(void)
{
    ...
    hr = UnRegisterTypeLib(LIBID_Office, 1, 0, 0, SYS_WIN32);
