...
HRESULT com::sun::star::style::CharacterProperties::setCharStrikeout( long value )
{
    TRACE_IN; 
    HRESULT hr;
    VARIANT res, param1;    
    ...
    hr = AutoWrap (DISPATCH_PROPERTYPUT, &res, m_pd_wrapper, L"CharStrikeout", 1, param1);
    if ( FAILED( hr ) )
    {
        ERR( " Call CharStrikeout \n" );
    }
...
HRESULT com::sun::star::style::CharacterProperties::getCharStrikeout( long& value)
{
    TRACE_IN; 
    HRESULT hr;
    VARIANT res;    
    ...
    hr = AutoWrap(DISPATCH_PROPERTYGET, &res, m_pd_wrapper, L"CharStrikeout", 0 );
    if ( FAILED( hr ) )
    {
        ERR( " Call CharStrikeout \n" );
        TRACE_OUT;
